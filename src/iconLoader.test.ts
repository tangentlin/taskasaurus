...
describe("buildTasksMetadata", () => {
  ...
  describe("definedLabels", () => {
    it("collects all task labels", () => {
      const tasks: TaskDefinition[] = [{ label: "Build" }, { label: "Test" }, { label: "Run" }];
    ...
    it("includes hidden tasks in defined labels", () => {
      const tasks: TaskDefinition[] = [{ label: "Build", hide: true }, { label: "Test" }];
  ...
  describe("groupOverrides", () => {
    ...
    it("merges group overrides from single folder", () => {
      const tasks: TaskDefinition[] = [{ label: "Build" }];
      const overrides: TasksJsonGroupOverrides = new Map([
        ["Test", { shortLabel: false }],
      ]);
    ...
    it("first folder wins for duplicate group overrides", () => {
      const overrides1: TasksJsonGroupOverrides = new Map([
        ["Test", { shortLabel: false }],
      ]);
      const overrides2: TasksJsonGroupOverrides = new Map([
