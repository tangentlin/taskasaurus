...
| `taskasaurus.showChildIndicator`  | boolean | `true`  | Falls back to `true` if not a boolean                      |
...
| ------------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `TaskasaurusConfig` | `src/config.ts` | Validated settings snapshot. See `src/config.ts` for the exact field list.                                                  |
